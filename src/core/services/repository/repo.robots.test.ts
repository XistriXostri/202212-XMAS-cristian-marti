...
import { RobotsRepo } from './repo.robots';

describe('Given a RobotsRepo', () => {
    const mockData = [
        new Robot('Test name 1', 1, 1, 'Test creatior 1'),
        new Robot('Test name 2', 2, 2, 'Test creatior 2'),
    ];
    ...
    describe('When we use create method', () => {
        test(`Then if the data are VALID, we received the robot 
            ...
            expect(data).toHaveProperty('image', mockNewRobotPayload.image);
        });
